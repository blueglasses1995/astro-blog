...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    description: 'レガシーシステムのSonarQube定量分析（13万行、1,451バグ検出）、NotebookLMを活用したRAG型社内検索基盤の提案、短期拡張PoC構想。経営判断向けスライド資料によりCOO承認を獲得。',
...
export const projects: Project[] = [
  ...
  {
    id: '2',
    title: 'RFC5545 繰り返しタスクエンジン',
    description: 'iCalendar標準規格に準拠した繰り返しタスクのハイブリッドマテリアライゼーション。generate_series + UNION ALLによる再帰CTEでDBを単一の真実の源泉とする設計。',
    image: '/projects/recurring-task.jpg',
    tags: ['TypeScript', 'PostgreSQL', 'GraphQL', 'NestJS'],
    featured: true,
  },
  {
    id: '3',
    title: 'RBAC+ReBAC 混合アクセス制御',
    description: '「誰が（ロール）」「何に対して（リソース）」「何をできるか（アクション）」の3軸で権限を制御するハイブリッドACLモデル。deny-by-defaultの3段階評価で30以上のユースケースを検証。',
    image: '/projects/acl.jpg',
    tags: ['TypeScript', 'NestJS', 'CASL', 'PostgreSQL'],
    featured: true,
  },
  {
    id: '4',
    title: '翻訳後処理マイクロサービス',
    description: '9状態の有限状態マシンによるジョブ管理と不可変イベントソーシング。Celery分散タスク処理でバッチ翻訳を非同期実行し、完全なトレーサビリティを実現。',
    image: '/projects/translation.jpg',
    tags: ['Python', 'FastAPI', 'Celery', 'Docker', 'PostgreSQL'],
  },
  {
    id: '5',
    title: 'VRTパイプライン',
    description: 'Storybook + storycap + reg-suitによるビジュアルリグレッションテスト。GitHub Actions matrix戦略で215ストーリー+49ページを並列実行し、0.1%ピクセル差分閾値で100%プレマージ検出。',
    image: '/projects/vrt.jpg',
    tags: ['Storybook', 'GitHub Actions', 'Playwright', 'React'],
  },
  {
    id: '6',
    title: 'Career Pipeline',
    description: 'キャリアデータをSQLiteで構造化管理し、CV自動生成・STAR面接練習・技術レーダーを提供するMCPサーバー。',
